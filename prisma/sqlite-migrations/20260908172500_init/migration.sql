-- Archived SQLite migration. The active PostgreSQL migration is in prisma/migrations/20260908172500_init.
-- This file is retained only as a reference for migrating existing SQLite data.
